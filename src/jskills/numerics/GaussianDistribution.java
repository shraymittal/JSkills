...
public class GaussianDistribution {
	...
	public GaussianDistribution(double mean, double standardDeviation) {
		this(mean, standardDeviation, square(standardDeviation), 1.0 / square(standardDeviation), mean
	...
	public static double logRatioNormalization(GaussianDistribution numerator, GaussianDistribution denominator) {
		...
		double logSqrt2Pi = log(sqrt(2 * PI));
		return log(denominator.variance) + logSqrt2Pi - log(varianceDifference) / 2.0 + square(meanDifference)
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (java.lang.Double.compare(this.getStandardDeviation(), other.getStandardDeviation()) != 0)
			return false;
		if (java.lang.Double.compare(this.getVariance(), other.getVariance()) != 0)
			return false;
		if (java.lang.Double.compare(this.getPrecision(), other.getPrecision()) != 0)
			return false;
		if (java.lang.Double.compare(this.getPrecisionMean(), other.getPrecisionMean()) != 0)
			return false;
		return true;
	}
